metagene_promoter_distal <- function(bigwig_files_location, name, plus, minus, pos_strand="//biochstore4.bioch.ox.ac.uk/Mellor/Rosa/pos_strand_annotations.bed", neg_strand="//biochstore4.bioch.ox.ac.uk/Mellor/Rosa/neg_strand_annotations.bed", binsize=5, MinPlus_ann=c("plus|posstrand|unipos","minus|negstrand|unimin")) {
  ...
  source("C:/Users/immd0754/Documents/R_things/General R scripts/metagene/distal_proximal_ratio.R")
  distprox <- ratio_body_promoter(minus, plus, binsize, combined)
